 ...
 */
public abstract class Hilt_AddProductFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_AddProductFragment() {
    super();
  }

  Hilt_AddProductFragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((AddProductFragment_GeneratedInjector) this.generatedComponent()).injectAddProductFragment(UnsafeCasts.<AddProductFragment>unsafeCast(this));
    }
  }
