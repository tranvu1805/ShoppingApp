 ...
 */
public abstract class Hilt_BillFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_BillFragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((BillFragment_GeneratedInjector) this.generatedComponent()).injectBillFragment(UnsafeCasts.<BillFragment>unsafeCast(this));
    }
  }
