 ...
 */
public abstract class Hilt_HomeCategoryFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_HomeCategoryFragment() {
    super();
  }

  Hilt_HomeCategoryFragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((HomeCategoryFragment_GeneratedInjector) this.generatedComponent()).injectHomeCategoryFragment(UnsafeCasts.<HomeCategoryFragment>unsafeCast(this));
    }
  }
